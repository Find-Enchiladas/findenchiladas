      ...
      <div class="row">
        <div class="col-lg-3 col-md-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>{{ DB::table('favorites')->where('user_id', Auth::user()->id )->count() }}</h3>
        ...
        <div class="col-lg-9 col-md-9 col-xs-6">
          <form method="POST" action="/user/favorites">
            ...
            <div class="form-group">
              ...
              <select id="favorites" name="favorites[]" class="form-control" multiple="multiple">
                @foreach($favorites as $fav)
                  <option value="{{ $fav->food_name }}" selected>{{ strtolower($fav->food_name) }}</option>
                @endforeach
              </select>
            </div>
        ...
        {{-- <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>{{ DB::table('')) }}<sup style="font-size: 20px">%</sup></h3>
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="box box-solid bg-teal-gradient">
            <div class="box-header">
              ...
              <h3 class="box-title">Blog Views</h3>
